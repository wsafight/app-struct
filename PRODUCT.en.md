...
Social login can now declare `modules.auth.providers: [google, github]`; `oauth: true` remains the generic OIDC shorthand. Billing is not generated yet; `appstruct capabilities --format json` reports Stripe as planned.
