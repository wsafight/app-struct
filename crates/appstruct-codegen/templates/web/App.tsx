      ...
      <Route element={<Layout resources={resources} />}>
        ...
        {resources.map((resource) => (
          <Route key={resource.name}>
            <Route path={resource.slug} element={<ResourceList resource={resource} />} />
            <Route path={`${resource.slug}/new`} element={<ResourceForm resource={resource} />} />
            <Route path={`${resource.slug}/:id/edit`} element={<ResourceForm resource={resource} />} />
          </Route>
        ))}
