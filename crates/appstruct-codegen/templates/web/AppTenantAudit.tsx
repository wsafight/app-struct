...
export function App({ registry }: { registry?: AppStructRegistry }) {
  ...
  return <AuthProvider><Routes>
    <Route path="login" element={<LoginPage />} /><Route path="register" element={<RegisterPage />} /><Route path="forgot-password" element={<ForgotPasswordPage />} /><Route path="reset-password" element={<ResetPasswordPage />} /><Route path="accept-invitation" element={<InvitationAcceptPage />} /><Route path="verify-email" element={<VerifyEmailPage />} />
    <Route element={<RequireAuth />}><Route element={<TenantProvider><RequireTenant /></TenantProvider>}><Route element={<Layout resources={resources} pages={customPages} />}>
      ...
      <Route path="empty" element={<main className="page"><h1>No accessible resources</h1></main>} /><Route path="organization" element={<OrganizationPage />} /><Route path="tokens" element={<ApiTokensPage />} /><Route path="admin" element={<AdminPage />} /><Route path="admin/jobs" element={<AdminJobsPage />} />
    </Route></Route></Route>
  </Routes></AuthProvider>;
}
