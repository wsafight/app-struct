...
export function ResourceFilters({ fields, resources, searchParams, updateParam }: ResourceFiltersProps) {
...
export function buildResourceFilterQuery(fields: FieldDefinition[], searchParams: URLSearchParams) {
  return {
    filters: Object.fromEntries(
      fields.map((field) => [field.name, searchParams.get(`filter[${field.name}]`) ?? ""]),
    ),
...
function FilterControl({ field, resources, searchParams, updateParam }: Omit<ResourceFiltersProps, "fields"> & { field: FieldDefinition }) {
