...
const ResourceDetail = lazy(() =>
  import("../pages/ResourceDetail").then(({ ResourceDetail: component }) => ({
    default: component,
  })),
);
const ResourceForm = lazy(() =>
  import("../pages/ResourceForm").then(({ ResourceForm: component }) => ({
    default: component,
  })),
);
const ResourceList = lazy(() =>
  import("../pages/ResourceList").then(({ ResourceList: component }) => ({
    default: component,
  })),
);
  ...
  return resources.flatMap((resource) => [
    {
      path: `/${resource.slug}`,
      component: () => (
        <ResourceList resource={resource} resources={resources} />
      ),
