use crate::{
    ColumnSchema, DatabaseSchema, DatabaseType, ForeignKeySchema, IndexSchema, SeedSchema,
...
#[must_use]
pub fn column_definition(column: &ColumnSchema, inline_primary_key: bool) -> String {
...
#[must_use]
pub fn sql_default(column: &ColumnSchema) -> Option<String> {
...
#[must_use]
pub fn add_foreign_key(foreign_key: &ForeignKeySchema) -> String {
...
#[must_use]
pub fn add_unique_constraint(constraint: &UniqueConstraintSchema) -> String {
...
#[must_use]
pub fn add_index(index: &IndexSchema) -> String {
...
#[must_use]
pub fn add_seed(seed: &SeedSchema) -> String {
    let columns = seed
        .values
        .iter()
